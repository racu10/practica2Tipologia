...
¿En qué genero deberían invertir las empresas para garantizar una mayor probabilidad de éxito en Europa? Pues como ya se ha mencionado anteriormente, dichos datos proporcionan información relevante respecto a cuál es el contenido que más éxito está teniendo y por lo tanto en cual han de seguir trabajando. Por otro lado, también puede responder a ¿El género con mayor rating es el que más ventas produce? Es decir, si los productos más vendidos son también los más valorados. Pues de este modo, ayudara a las empresas a deducir si las ventas están o no relacionadas con las puntuaciones y críticas de los usuarios. 
...
boxplot(videoGamesSales$NA_Sales)
boxplot(videoGamesSales$JP_Sales)
...
#### -	¿En qué genero deberían invertir las empresas para garantizar una mayor probabilidad de éxito en Europa?
...
#### -	¿El género con mayor rating es el que más ventas produce?
